...
if __name__ == '__main__':
	...
	# graph just BigMoney testing/training
	BigMWins = [0.27, 0.26, 0.29, 0.32, 0.33, 0.26, 0.22, 0.14, 0.28, 0.29, 0.2, 0.24, 0.3, 0.25, 0.2, 0.25, 0.23, 0.27, 0.22, 0.28]
	BigMTies = [0.18, 0.23, 0.25, 0.28, 0.21, 0.27, 0.21, 0.22, 0.29, 0.23, 0.23, 0.24, 0.29, 0.3, 0.23, 0.28, 0.31, 0.16, 0.21, 0.27]

	plt.plot(BigMWins, 'g-', label='Win Rate')
	plt.plot(BigMTies, 'm--', label='Tie Rate')

	plt.legend()
	plt.xlabel("Rounds")
	plt.title("Win and Tie Rates During Training with BigMoney, \n Playing Against Greedy")
	plt.show()
